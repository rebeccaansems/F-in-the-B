...
namespace VoxelBusters.DebugPRO.Internal
{
	public partial class NativeBinding : MonoBehaviour 
	{
		...
		{
#if UNITY_IOS
			debugProLogMessage(_log.Message, _log.Type, _log.CallStack);
#elif UNITY_ANDROID
			PluginNativeBinding.CallStatic(NativeInfo.Methods.LOG, _log.Message.ToBase64(), kLogTypeMap[_log.Type], _log.CallStack.ToBase64());
#endif
		}
